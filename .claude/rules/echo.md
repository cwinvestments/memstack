...
2. Run: `python db/memstack-db.py search "<keywords>"` (add `--project <name>` if project is known)
3. Run: `python db/memstack-db.py get-sessions <project> --limit 5` for recent sessions
4. Run: `python db/memstack-db.py get-insights <project>` for decisions and patterns
