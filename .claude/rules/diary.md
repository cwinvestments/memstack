...
3. Save session: `python ~/Projects/memstack/db/memstack-db.py add-session '<json>'`
4. Extract each decision as an insight: `python ~/Projects/memstack/db/memstack-db.py add-insight '<json>'`
5. Update project context: `python ~/Projects/memstack/db/memstack-db.py set-context '<json>'`
