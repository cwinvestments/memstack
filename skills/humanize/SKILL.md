...
| **User is writing code or technical docs (API refs, JSDoc)** | DORMANT, technical writing is fine as-is | none |
| **User is writing commit messages or changelogs** | DORMANT, these have their own format | none |
