...
echo  [1/3] Starting Headroom proxy on port 8787...
start /min "Headroom Proxy" cmd /c "headroom proxy --port 8787"

REM 2. Wait for initialization
echo  [2/3] Waiting for Headroom to initialize...
timeout /t 2 /nobreak >nul

REM 3. Health check
echo  [3/3] Checking Headroom health...
...
echo.
echo  =========================================
echo  MemStack v3.2 ready — 19 skills loaded
echo  =========================================
echo.
