...
MemStack™ gives Claude Code **131 professional skills**: deployment, security, database design, content writing, marketing, and more. Skills activate automatically when you need them.

**87 skills are free.** A Pro license key unlocks all 131 skills including 44 Pro-exclusive skills. Get a key at [memstack.pro](https://memstack.pro).
...
A Pro license unlocks all 131 skills including 44 Pro-exclusive skills.
...
3. Restart Claude Code and activate your license:
   ...
   ```
4. Pro skills download automatically from our server to `~/.memstack/pro-skills` (no separate marketplace step for Pro). You should see all 131 skills (87 free + 44 Pro).
...
|------|----------------|---------------|
| **Free skills** | the 87 free skills, including new releases | In Claude Code: `/plugin marketplace update cwinvestments-memstack`, then `/reload-plugins` (or restart) |
...
### Skill Categories (131 total: 87 free + 44 Pro)
