...
| `token-optimization` | Reduce token consumption by 50-80% using the 3-layer optimization stack: TokenStack™ (API compression), RTK (CLI output compression), and Serena (LSP-backed code navigation). | TokenStack™-only troubleshooting. |
